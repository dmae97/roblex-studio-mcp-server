...
// Type for Open Cloud connector parameters
 ...
 */
export const openCloudConnector: McpTool<OpenCloudConnectorParams> = {
  ...
  execute: async (params: OpenCloudConnectorParams): Promise<McpToolResult> => {
    // Check for API key
 ...
 */
async function handleDataStoresAction(
  actionType: string, 
  universeId: string, 
  ...
  switch (actionType) {
    ...
    case 'get':
      ...
      if (!dataStore) throw new Error('dataStore parameter is required');
      if (!entryKey) throw new Error('entryKey parameter is required');
    ...
    case 'update':
      ...
      if (!setDataStore) throw new Error('dataStore parameter is required');
      if (!setEntryKey) throw new Error('entryKey parameter is required');
      if (data === undefined) throw new Error('data parameter is required');
    ...
    case 'delete':
      ...
      if (!deleteDataStore) throw new Error('dataStore parameter is required');
      if (!deleteEntryKey) throw new Error('entryKey parameter is required');
 ...
 */
async function handleMessagingAction(
  actionType: string, 
  universeId: string, 
  parameters: Record<string, any>
): Promise<any> {
  ...
  switch (actionType) {
    case 'message':
      ...
      if (!topic) throw new Error('topic parameter is required');
      if (message === undefined) throw new Error('message parameter is required');
 ...
 */
async function handlePlacePublishingAction(
  actionType: string, 
  universeId: string, 
  parameters: Record<string, any>
): Promise<any> {
  ...
  switch (actionType) {
    case 'publish':
      ...
      if (!placeId) throw new Error('placeId parameter is required');
      if (!fileData) throw new Error('fileData parameter is required');
    ...
    case 'get':
      ...
      if (!getPlaceId) throw new Error('placeId parameter is required');
 ...
 */
async function handleGameConfigAction(
  actionType: string, 
  universeId: string, 
  parameters: Record<string, any>
): Promise<any> {
  ...
  switch (actionType) {
    ...
    case 'update':
      ...
      if (!configuration) throw new Error('configuration parameter is required');
 ...
 */
async function handlePlayerModerationAction(
  actionType: string, 
  universeId: string, 
  parameters: Record<string, any>
): Promise<any> {
  ...
  switch (actionType) {
    case 'moderate':
      ...
      if (!action) throw new Error('action parameter is required (ban, unban, kick, mute, unmute)');
    ...
    case 'get':
      ...
      if (!getStatusUserId) throw new Error('userId parameter is required');
 ...
 */
async function handleAnalyticsAction(
  actionType: string, 
  universeId: string, 
  parameters: Record<string, any>
): Promise<any> {
  ...
  switch (actionType) {
    case 'query':
      ...
      if (!metric) throw new Error('metric parameter is required');
      if (!timeFrame) throw new Error('timeFrame parameter is required');
      
      let url = `${baseUrl}/metrics/${metric}?timeFrame=${timeFrame}`;
      
      if (placeId) url += `&placeId=${placeId}`;
      if (segmentation) url += `&segmentation=${segmentation}`;
 ...
 */
async function handlePlaceManagementAction(
  actionType: string, 
  universeId: string, 
  parameters: Record<string, any>
): Promise<any> {
  ...
  switch (actionType) {
    ...
    case 'update':
      ...
      if (!updatePlaceId) throw new Error('placeId parameter is required');
    ...
    case 'delete':
      ...
      if (!deletePlaceId) throw new Error('placeId parameter is required');
