...
import { createRoblexStudioAdapterFactory } from './RoblexStudioAdapter.js';
/**
 ...
 */
export function createMcp(name, initialState = {}) {
 ...
 */
export function createGameObjectMcp(objectName, objectType, initialProperties = {}) {
    const initialState = {
        type: objectType,
 ...
 */
export function createUiComponentMcp(componentName, componentType, initialProperties = {}) {
    const initialState = {
        type: componentType,
 ...
 */
export function createRoblexStudioScriptMcp(scriptName, scriptType = 'Script', source = '', parent = 'ServerScriptService') {
 ...
 */
export function createRoblexStudioUIMcp(uiName, className = 'Frame', initialProperties = {}) {
 ...
 */
export function createRoblexStudioServiceMcp(serviceName, initialProperties = {}) {
