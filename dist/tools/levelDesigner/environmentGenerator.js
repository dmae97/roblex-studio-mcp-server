...
exports.generateEnvironmentCode = void 0;
const utils_js_1 = require("./utils.js");
/**
 * Generates code for environment settings
 */
function generateEnvironmentCode(params) {
...
`;
    ...
    if (lighting) {
        code += `
    -- Configure lighting
    ${lighting.ambient ? `lighting.Ambient = Color3.fromRGB(${(0, utils_js_1.parseColor)(lighting.ambient)})` : ''}
    ...
    ${lighting.colorShift?.top ? `lighting.ColorShift_Top = Color3.fromRGB(${(0, utils_js_1.parseColor)(lighting.colorShift.top)})` : ''}
    ${lighting.colorShift?.bottom ? `lighting.ColorShift_Bottom = Color3.fromRGB(${(0, utils_js_1.parseColor)(lighting.colorShift.bottom)})` : ''}
`;
    }
    ...
    ${fog.color ? `lighting.FogColor = Color3.fromRGB(${(0, utils_js_1.parseColor)(fog.color)})` : ''}
`;
    }
    ...
    ${atmosphere.color ? `atmosphere.Color = Color3.fromRGB(${(0, utils_js_1.parseColor)(atmosphere.color)})` : ''}
...
exports.generateEnvironmentCode = generateEnvironmentCode;
