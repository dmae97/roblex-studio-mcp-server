 ...
 */
function generateMainScript(params) {
 ...
 */
function generateTraditionalUIScript(params) {
 ...
 */
function generateRoactScript(params) {
 ...
 */
function generateStyleScript(params) {
 ...
 */
function generateControllerScript(params) {
    return `--[[
 ...
 */
function generateUsageInstructions(params) {
 ...
 */
function generateAnimationsCode(uiType) {
    return `
-- Animation functions
 ...
 */
function getUIHierarchy(params) {
 ...
 */
function getRoactComponents(params) {
    const { uiType, elements } = params;
    switch (uiType) {
        case 'Menu':
            return `{
 ...
 */
function getColorScheme(params) {
 ...
 */
function getFontAndDesign(stylePreset) {
    switch (stylePreset) {
        case 'Modern':
            return {
